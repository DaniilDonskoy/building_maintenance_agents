...
class RiserNode(BaseNode):
    ...
    def __post_init__(self) -> None:
        if any(key not in self.features for key in ("section", "floor", "flat_index", "flats_per_section")):
            raise ValueError("RiserNode requires 'section', 'floor', 'flat_index', and 'flats_per_section' in features")
        ...
        riser_x = section_x + (flat_index - (flats_per_section + 1) / 2) * FLAT_SPACING
